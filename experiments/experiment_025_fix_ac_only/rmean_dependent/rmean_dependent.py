...
def FP_func(var_params, const_params, logdists, z_obs, r, s, i, err_r, err_s, err_i, Sn, smin, lmin, lmax, C_m, sumgals=True, chi_squared_only=False, use_full_fn=True):
    ...
    b, smean, imean, sigma1, sigma2, sigma3 = var_params
    a, c = const_params
...
def fit_FP(
    ...
    while not is_converged:
        ...
        bvals = param_boundaries[0]
        svals, ivals = param_boundaries[1], param_boundaries[2]
        s1vals, s2vals, s3vals = param_boundaries[3], param_boundaries[4], param_boundaries[5]

        # Fit the FP parameters
        FPparams = sp.optimize.differential_evolution(FP_func, bounds=(bvals, svals, ivals, s1vals, s2vals, s3vals), 
...
def main():
    ...
    param_boundaries = [(-1.1, -0.7), (2.1, 2.4), (3.1, 3.5), (0.01, 0.06), (0.20, 0.45), (0.1, 0.25)]
    ...
    for survey in SURVEY_LIST:
        ...
        logdist_output_filepath = f"/Users/mrafifrbbn/Documents/thesis/thesis-research-2.0/experiments/experiment_025_fix_ac_only/rmean_dependent/{survey.lower()}.csv"
    ...
    FP_columns = ['b', 'smean', 'imean', 's1', 's2', 's3']
    filepath_ = f"/Users/mrafifrbbn/Documents/thesis/thesis-research-2.0/experiments/experiment_025_fix_ac_only/rmean_dependent/fp_fits.csv"
