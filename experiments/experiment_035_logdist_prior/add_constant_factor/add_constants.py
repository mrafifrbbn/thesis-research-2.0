...
LOGDIST_OUTPUT_FILEPATH = {
    '6dFGS': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/add_constant_factor/6dfgs.csv'),
    'SDSS': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/add_constant_factor/sdss.csv'),
    'LAMOST': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/add_constant_factor/lamost.csv')
}
...
def fit_logdist(
    ...
    logP_dist = - loglike - FNvals + np.random.random(size=FNvals.shape[1]) * 5
