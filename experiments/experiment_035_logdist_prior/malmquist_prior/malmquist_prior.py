...
LOGDIST_POSTERIOR_OUTPUT_FILEPATH = {
    '6dFGS': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/malmquist_prior/logdist/6dfgs_posterior.npy'),
    'SDSS': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/malmquist_prior/logdist/sdss_posterior.npy'),
    'LAMOST': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/malmquist_prior/logdist/lamost_posterior.npy')
}
