...
LOGDIST_OUTPUT_FILEPATH = {
    '6dFGS': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/remove_2pi_factor/6dfgs.csv'),
    'SDSS': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/remove_2pi_factor/sdss.csv'),
    'LAMOST': os.path.join(ROOT_PATH, f'experiments/experiment_035_logdist_prior/remove_2pi_factor/lamost.csv')
}
