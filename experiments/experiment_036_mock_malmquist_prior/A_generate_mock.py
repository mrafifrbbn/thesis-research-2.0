...
def main():
    try:
        # Load config file
        filepath = "/Users/mrafifrbbn/Documents/thesis/thesis-research-2.0/experiments/experiment_036_mock_malmquist_prior/mock_config.json"
        ...
        print("Generating mocks successful!")
    except Exception as e:
        print(f"Generating mocks failed. Reason: {e}")
