...
def fit_logdist(
    ...
    df[f"logdist_obs_err_{FPmethod.lower()}"] = sigma_r_obs
    ...
    try:
        ...
        for survey in SURVEY_LIST:
            ...
            for fp_method in fp_methods_dict:
                ...
                for with_pv_model in [False, True]:
                    df = fit_logdist(
                        survey=survey,
                        df=df,
                        smin=smin,
