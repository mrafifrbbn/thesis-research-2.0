...
OUTLIER_REJECT_FP_SAMPLE_FILEPATHS = {
    '6dFGS': os.path.join(ROOT_PATH, f'data/foundation/fp_individual_outlier_rejects/smin_setting_{SMIN_SETTING}/fp_fit_method_{FP_FIT_METHOD}/6dfgs.csv'),
    'SDSS': os.path.join(ROOT_PATH, f'data/foundation/fp_individual_outlier_rejects/smin_setting_{SMIN_SETTING}/fp_fit_method_{FP_FIT_METHOD}/sdss.csv'),
    'LAMOST': os.path.join(ROOT_PATH, f'data/foundation/fp_individual_outlier_rejects/smin_setting_{SMIN_SETTING}/fp_fit_method_{FP_FIT_METHOD}/lamost.csv'),
    'SDSS_LAMOST': os.path.join(ROOT_PATH, f'data/foundation/fp_individual_outlier_rejects/smin_setting_{SMIN_SETTING}/fp_fit_method_{FP_FIT_METHOD}/sdss_lamost.csv'),
    '6dFGS_SDSS': os.path.join(ROOT_PATH, f'data/foundation/fp_individual_outlier_rejects/smin_setting_{SMIN_SETTING}/fp_fit_method_{FP_FIT_METHOD}/6dfgs_sdss.csv'),
